...
(function () {
  ...
  const TABS = [
    ...
    { key:'us',    label:'ふたり',   icon:'💗', href:'/closer.html', match:p => ['/closer.html','/thanks.html','/one_on_one.html','/time_capsule.html','/status.html','/dates.html','/one_song.html','/workout.html','/goals.html'].includes(p) },
